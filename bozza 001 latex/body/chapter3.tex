...
\textcolor{red}{PERCHE MI SEMBRANO SCHIACCIATe LE TABELLE? ho cambiato TINY->SMALL, ps LEGGERE COMMENTI}
...
\begin{table}[h!]
   ...
   % GCS & > 8 & xx (xx\%) \\ 
   % GCS & =< 8 & 54 (13.14\%) \\
    \textcolor{red}{PUPIL} & non reactive & xx (xx\%) \\ % Placeholder data; replace with actual values
    %ICPm & True & 372 (90.51\%) \\
    %ICPm & False & 39 (9.49\%) \\
